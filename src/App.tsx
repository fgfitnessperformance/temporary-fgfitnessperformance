  ...
  return (
    <div className="bg-fg-base text-fg-text h-[100dvh] w-full overflow-hidden flex flex-col relative font-body">
      ...
      <main className="flex-1 min-h-0 flex flex-col items-center justify-center px-4 py-2 md:p-6 relative z-10 w-full max-w-5xl mx-auto text-center pt-[env(safe-area-inset-top)]">
        ...
        <div className="mb-2 md:mb-10 relative group">
        ...
        <div className="h-0.5 md:h-1 w-10 md:w-24 bg-fg-gold mb-2 md:mb-8 rounded-full animate-line-glow" />

        <p className="text-xs md:text-xl text-white/80 max-w-2xl leading-snug md:leading-relaxed mb-4 md:mb-10 px-2">
        ...
        <div className="flex flex-col items-center gap-1 md:gap-4">
          <p className="text-fg-muted text-[10px] md:text-sm uppercase tracking-widest">Siguenos en</p>
          ...
          <div className="flex md:hidden gap-3">
            <a
              ...
              className="w-9 h-9 rounded-full bg-fg-surface/80 border border-white/10 flex items-center justify-center hover:border-fg-gold hover:shadow-[0_0_15px_rgba(255,215,0,0.4)] transition-all duration-300"
            >
      ...
      <footer className="relative z-10 py-2 md:py-6 text-center border-t border-white/5 bg-fg-base/90 backdrop-blur-sm w-full shrink-0 pb-[max(0.5rem,env(safe-area-inset-bottom))]">
        <div className="flex items-center justify-center gap-3 md:gap-4 px-4">
          <p className="text-fg-muted text-[9px] md:text-xs tracking-widest uppercase">
